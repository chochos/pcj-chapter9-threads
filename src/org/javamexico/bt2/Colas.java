...
public class Colas {
	...
	public static void main(String[] args) {
		LinkedBlockingQueue<Integer> cola = new LinkedBlockingQueue<Integer>();
		ProductorQueue prod = new ProductorQueue(cola);
		ConsumidorQueue cons = new ConsumidorQueue(cola);
