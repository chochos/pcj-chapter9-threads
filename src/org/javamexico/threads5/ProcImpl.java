...
/** Ejemplo 4 ilustra un deadlock
 * 
 * @author Enrique Zamudio
 */
public class ProcImpl extends Procesador {

	/** Hace la transferencia, bloqueando a los 2 involucrados para
	 * que solamente se pueda realizar esto una vez aunque se invoque
	 * por varios Threads. */
